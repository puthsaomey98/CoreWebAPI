...
string connectionString = builder.Configuration.GetConnectionString("DockerConnectionString");

builder.Services.Configure<AppSettings>(builder.Configuration.GetSection("AppSettings"));

builder.Services.AddDbContext<OurHeroDbContext>(options => options.UseNpgsql(connectionString), ServiceLifetime.Singleton);
